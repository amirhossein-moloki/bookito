...
DEBUG = os.getenv('DJANGO_DEBUG', 'True') == 'True'  # قابلیت تغییر از محیط
...
# CORS settings
CORS_ALLOWED_ORIGINS = os.getenv('CORS_ALLOWED_ORIGINS', 'http://127.0.0.1:5500,http://localhost:3000,http://localhost:8000').split(',')
